...
func (m *PanicMarket) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
var fileDescriptor_497e7cde817162d1 = []byte{
	...
	0x64, 0x72, 0x7e, 0x71, 0x6e, 0x7e, 0x71, 0x3c, 0x58, 0x95, 0x3e, 0x84, 0x03, 0xd1, 0xa2, 0x14,
	0xca, 0xc5, 0x1d, 0x00, 0x32, 0xc1, 0x17, 0xac, 0x58, 0x48, 0x88, 0x8b, 0x25, 0x25, 0xb1, 0x24,
	0x51, 0x82, 0x51, 0x81, 0x51, 0x83, 0x27, 0x08, 0xcc, 0xb6, 0x32, 0x3a, 0xb5, 0x45, 0x57, 0x0f,
	0xbb, 0xc9, 0x7a, 0x6e, 0xa9, 0xa9, 0x10, 0x9d, 0x9e, 0xb9, 0x05, 0x39, 0xa9, 0xb9, 0xa9, 0x79,
	0x25, 0x89, 0x25, 0x99, 0xf9, 0x79, 0x4e, 0x81, 0x27, 0x1e, 0xc9, 0x31, 0x5e, 0x78, 0x24, 0xc7,
	...
	0x9d, 0x59, 0xa0, 0x9b, 0x9b, 0x5a, 0x86, 0xe4, 0xa3, 0x0a, 0x24, 0x76, 0x41, 0x4e, 0x69, 0x7a,
	0x66, 0x5e, 0xb1, 0x7e, 0x6e, 0x7e, 0x72, 0x76, 0x71, 0x12, 0x1b, 0xd8, 0xc1, 0xc6, 0x80, 0x00,
	0x00, 0x00, 0xff, 0xff, 0xe7, 0x29, 0xf1, 0xd2, 0x09, 0x01, 0x00, 0x00,
}
...
func (m *PanicMarket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Data) > 0 {
		i -= len(m.Data)
		copy(dAtA[i:], m.Data)
		i = encodeVarintPanic(dAtA, i, uint64(len(m.Data)))
		i--
		dAtA[i] = 0xa
	}
